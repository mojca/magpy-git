...
print("Using Twisted reactor {}".format(reactor.__class__))
print()
...
print("Autobahn Version: {}".format(autobahnversion))
try: # version > 0.8.0
...
def GetSensors():
    ...
    print("Found {} {} {}".format(sensorlist, portdict, baudratedict))
    ...
    def __init__(self, url):
	    ...
	    if sensor[:2].upper() == 'OW':
            ...
            if sensor[:3].upper() == 'KER':
                print("Test1: {}".format(sensor.strip))
